...
public class IabHelper {
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // With response code 7, (BILLING_RESPONSE_RESULT_ITEM_ALREADY_OWNED) it would be nice to get users email address. It is contained in the array bundle named ????????.KEY_ACCOUNT and this does not seem to be standard by documentation, is it always included?
        //String userEmail = data.getExtras().get(RESPONSE_CODE);
